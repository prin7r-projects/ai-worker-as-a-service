...
export const metadata: Metadata = {
  ...
  title: "Tally — outcome ledger for AI workers",
  description:
    "Tally is the first AI worker service priced like payroll. You only pay when the shift ships. Pre-trained worker profiles, unit-priced outcome contracts, per-shift receipts. No retainer, no tokens, no seats.",
  openGraph: {
    title: "Tally — outcome ledger for AI workers",
